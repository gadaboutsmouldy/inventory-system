...
Partial Public Class inventoryDataSet3
    ...
    Partial Public Class quotationDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddquotationRow(ByVal QuotationID As Integer, ByVal _Date As Date, ByVal Quantity As Integer, ByVal Description As String, ByVal UnitPrice As Integer, ByVal Taxes As Decimal, ByVal Amount As Double, ByVal Subtotal As Double, ByVal TaxRate As Decimal, ByVal SalesTax As Decimal, ByVal TotalAmount As Double, ByVal ShipDate As Date, ByVal ShipVia As String, ByVal SalesPerson As String, ByVal PONumber As Integer) As quotationRow
            Dim rowquotationRow As quotationRow = CType(Me.NewRow,quotationRow)
            Dim columnValuesArray() As Object = New Object() {QuotationID, _Date, Quantity, Description, UnitPrice, Taxes, Amount, Subtotal, TaxRate, SalesTax, TotalAmount, ShipDate, ShipVia, SalesPerson, PONumber}
    ...
    Partial Public Class quotationRow
        ...
        Public Property PONumber() As Integer
            Get
                Try 
                    Return CType(Me(Me.tablequotation.PONumberColumn),Integer)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("The value for column 'PONumber' in table 'quotation' is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tablequotation.PONumberColumn) = value
            End Set
        End Property
        ...
        Public Function IsPONumberNull() As Boolean
            Return Me.IsNull(Me.tablequotation.PONumberColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Sub SetPONumberNull()
            Me(Me.tablequotation.PONumberColumn) = Global.System.Convert.DBNull
        End Sub
    End Class
    ...
    Partial Public Class quotationTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[quotation] WHERE (([QuotationID] = @Original_QuotationID) AND "& _ 
                ...
                "ull_PONumber = 1 AND [PONumber] IS NULL) OR ([PONumber] = @Original_PONumber)))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[quotation] ([QuotationID], [Date], [Quantity], [Description], "& _ 
                ...
                ", [ShipDate], [ShipVia], [SalesPerson], [PONumber]) VALUES (@QuotationID, @Date,"& _ 
                " @Quantity, @Description, @UnitPrice, @Taxes, @Amount, @Subtotal, @TaxRate, @Sal"& _ 
                "esTax, @TotalAmount, @ShipDate, @ShipVia, @SalesPerson, @PONumber);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT Quot"& _ 
                "ationID, Date, Quantity, Description, UnitPrice, Taxes, Amount, Subtotal, TaxRat"& _ 
                "e, SalesTax, TotalAmount, ShipDate, ShipVia, SalesPerson, PONumber FROM quotatio"& _ 
                "n WHERE (QuotationID = @QuotationID)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[quotation] SET [QuotationID] = @QuotationID, [Date] = @Date, [Quant"& _ 
                ...
                "pVia] = @ShipVia, [SalesPerson] = @SalesPerson, [PONumber] = @PONumber WHERE ((["& _ 
                "QuotationID] = @Original_QuotationID) AND ([Date] = @Original_Date) AND ([Quanti"& _ 
                "ty] = @Original_Quantity) AND ((@IsNull_Description = 1 AND [Description] IS NUL"& _ 
                "L) OR ([Description] = @Original_Description)) AND ([UnitPrice] = @Original_Unit"& _ 
                "Price) AND ((@IsNull_Taxes = 1 AND [Taxes] IS NULL) OR ([Taxes] = @Original_Taxe"& _ 
                "s)) AND ([Amount] = @Original_Amount) AND ([Subtotal] = @Original_Subtotal) AND "& _ 
                "((@IsNull_TaxRate = 1 AND [TaxRate] IS NULL) OR ([TaxRate] = @Original_TaxRate))"& _ 
                " AND ((@IsNull_SalesTax = 1 AND [SalesTax] IS NULL) OR ([SalesTax] = @Original_S"& _ 
                "alesTax)) AND ([TotalAmount] = @Original_TotalAmount) AND ((@IsNull_ShipDate = 1"& _ 
                " AND [ShipDate] IS NULL) OR ([ShipDate] = @Original_ShipDate)) AND ((@IsNull_Shi"& _ 
                "pVia = 1 AND [ShipVia] IS NULL) OR ([ShipVia] = @Original_ShipVia)) AND ([SalesP"& _ 
                "erson] = @Original_SalesPerson) AND ((@IsNull_PONumber = 1 AND [PONumber] IS NUL"& _ 
                "L) OR ([PONumber] = @Original_PONumber)));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT QuotationID, Date, Quantity, "& _ 
                "Description, UnitPrice, Taxes, Amount, Subtotal, TaxRate, SalesTax, TotalAmount,"& _ 
                " ShipDate, ShipVia, SalesPerson, PONumber FROM quotation WHERE (QuotationID = @Q"& _ 
                "uotationID)"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT QuotationID, Date, Quantity, Description, UnitPrice, Taxes, Amount, Subtot"& _ 
                "al, TaxRate, SalesTax, TotalAmount, ShipDate, ShipVia, SalesPerson, PONumber FRO"& _ 
                "M dbo.quotation"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As inventoryDataSet3.quotationDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As inventoryDataSet3.quotationDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As inventoryDataSet3.quotationDataTable = New inventoryDataSet3.quotationDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As inventoryDataSet3.quotationDataTable) As Integer
        ...
        Public Overloads Overridable Function Delete(ByVal Original_QuotationID As Integer, ByVal Original_Date As Date, ByVal Original_Quantity As Integer, ByVal Original_Description As String, ByVal Original_UnitPrice As Integer, ByVal Original_Taxes As Global.System.Nullable(Of Decimal), ByVal Original_Amount As Double, ByVal Original_Subtotal As Double, ByVal Original_TaxRate As Global.System.Nullable(Of Decimal), ByVal Original_SalesTax As Global.System.Nullable(Of Decimal), ByVal Original_TotalAmount As Double, ByVal Original_ShipDate As Global.System.Nullable(Of Date), ByVal Original_ShipVia As String, ByVal Original_SalesPerson As String, ByVal Original_PONumber As Global.System.Nullable(Of Integer)) As Integer
            ...
            If (Original_PONumber.HasValue = true) Then
                ...
                Me.Adapter.DeleteCommand.Parameters(21).Value = CType(Original_PONumber.Value,Integer)
            Else
        ...
        Public Overloads Overridable Function Insert(ByVal QuotationID As Integer, ByVal _Date As Date, ByVal Quantity As Integer, ByVal Description As String, ByVal UnitPrice As Integer, ByVal Taxes As Global.System.Nullable(Of Decimal), ByVal Amount As Double, ByVal Subtotal As Double, ByVal TaxRate As Global.System.Nullable(Of Decimal), ByVal SalesTax As Global.System.Nullable(Of Decimal), ByVal TotalAmount As Double, ByVal ShipDate As Global.System.Nullable(Of Date), ByVal ShipVia As String, ByVal SalesPerson As String, ByVal PONumber As Global.System.Nullable(Of Integer)) As Integer
            ...
            If (PONumber.HasValue = true) Then
                Me.Adapter.InsertCommand.Parameters(14).Value = CType(PONumber.Value,Integer)
            Else
        ...
        Public Overloads Overridable Function Update( _
                    ...
                    ByVal Original_PONumber As Global.System.Nullable(Of Integer)) As Integer
            ...
            End If
            If (PONumber.HasValue = true) Then
                Me.Adapter.UpdateCommand.Parameters(14).Value = CType(PONumber.Value,Integer)
            Else
                Me.Adapter.UpdateCommand.Parameters(14).Value = Global.System.DBNull.Value
            End If
            Me.Adapter.UpdateCommand.Parameters(15).Value = CType(Original_QuotationID,Integer)
            ...
            End If
            Me.Adapter.UpdateCommand.Parameters(20).Value = CType(Original_UnitPrice,Integer)
            If (Original_Taxes.HasValue = true) Then
                Me.Adapter.UpdateCommand.Parameters(21).Value = CType(0,Object)
                Me.Adapter.UpdateCommand.Parameters(22).Value = CType(Original_Taxes.Value,Decimal)
            Else
                Me.Adapter.UpdateCommand.Parameters(21).Value = CType(1,Object)
                Me.Adapter.UpdateCommand.Parameters(22).Value = Global.System.DBNull.Value
            End If
            Me.Adapter.UpdateCommand.Parameters(23).Value = CType(Original_Amount,Double)
            Me.Adapter.UpdateCommand.Parameters(24).Value = CType(Original_Subtotal,Double)
            If (Original_TaxRate.HasValue = true) Then
                Me.Adapter.UpdateCommand.Parameters(25).Value = CType(0,Object)
                Me.Adapter.UpdateCommand.Parameters(26).Value = CType(Original_TaxRate.Value,Decimal)
            Else
            ...
            If (Original_SalesTax.HasValue = true) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(28).Value = CType(Original_SalesTax.Value,Decimal)
            Else
                Me.Adapter.UpdateCommand.Parameters(27).Value = CType(1,Object)
                Me.Adapter.UpdateCommand.Parameters(28).Value = Global.System.DBNull.Value
            End If
            Me.Adapter.UpdateCommand.Parameters(29).Value = CType(Original_TotalAmount,Double)
            If (Original_ShipDate.HasValue = true) Then
                Me.Adapter.UpdateCommand.Parameters(30).Value = CType(0,Object)
                Me.Adapter.UpdateCommand.Parameters(31).Value = CType(Original_ShipDate.Value,Date)
            Else
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(33).Value = CType(Original_ShipVia,String)
            End If
            If (Original_SalesPerson Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_SalesPerson")
            Else
                Me.Adapter.UpdateCommand.Parameters(34).Value = CType(Original_SalesPerson,String)
            End If
            If (Original_PONumber.HasValue = true) Then
                Me.Adapter.UpdateCommand.Parameters(35).Value = CType(0,Object)
                Me.Adapter.UpdateCommand.Parameters(36).Value = CType(Original_PONumber.Value,Integer)
            Else
        ...
        Public Overloads Overridable Function Update( _
                    ...
                    ByVal Original_SalesPerson As String,  _
                    ByVal Original_PONumber As Global.System.Nullable(Of Integer)) As Integer
            Return Me.Update(Original_QuotationID, _Date, Quantity, Description, UnitPrice, Taxes, Amount, Subtotal, TaxRate, SalesTax, TotalAmount, ShipDate, ShipVia, SalesPerson, PONumber, Original_QuotationID, Original_Date, Original_Quantity, Original_Description, Original_UnitPrice, Original_Taxes, Original_Amount, Original_Subtotal, Original_TaxRate, Original_SalesTax, Original_TotalAmount, Original_ShipDate, Original_ShipVia, Original_SalesPerson, Original_PONumber)
        End Function
    End Class
