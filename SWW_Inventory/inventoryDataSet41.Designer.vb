...
Partial Public Class inventoryDataSet4
    ...
    Private Sub InitClass()
        ...
        Me.Prefix = ""
        Me.Namespace = "http://tempuri.org/inventoryDataSet41.xsd"
    ...
    Partial Public Class customersDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddcustomersRow(ByVal CustomerID As Integer, ByVal CustomerCompany As String, ByVal CustomerName As String, ByVal CustomerAddress As String, ByVal CustomerPhone As String, ByVal CustomerTIN As String, ByVal CustomerRemarks As String) As customersRow
            Dim rowcustomersRow As customersRow = CType(Me.NewRow,customersRow)
            Dim columnValuesArray() As Object = New Object() {CustomerID, CustomerCompany, CustomerName, CustomerAddress, CustomerPhone, CustomerTIN, CustomerRemarks}
    ...
    Partial Public Class customersTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[customers] WHERE (([CustomerID] = @Original_CustomerID) AND (["& _ 
                ...
                "LL) OR ([CustomerRemarks] = @Original_CustomerRemarks)))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[customers] ([CustomerID], [CustomerCompany], [CustomerName], ["& _ 
                "CustomerAddress], [CustomerPhone], [CustomerTIN], [CustomerRemarks]) VALUES (@Cu"& _ 
                "stomerID, @CustomerCompany, @CustomerName, @CustomerAddress, @CustomerPhone, @Cu"& _ 
                "stomerTIN, @CustomerRemarks);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT CustomerID, CustomerCompany, CustomerName,"& _ 
                " CustomerAddress, CustomerPhone, CustomerTIN, CustomerRemarks FROM customers WHE"& _ 
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[customers] SET [CustomerID] = @CustomerID, [CustomerCompany] = @Cus"& _ 
                ...
                "arks] = @CustomerRemarks WHERE (([CustomerID] = @Original_CustomerID) AND ([Cust"& _ 
                "omerCompany] = @Original_CustomerCompany) AND ([CustomerName] = @Original_Custom"& _ 
                ...
                "OR ([CustomerRemarks] = @Original_CustomerRemarks)));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT CustomerID, Custom"& _ 
                "erCompany, CustomerName, CustomerAddress, CustomerPhone, CustomerTIN, CustomerRe"& _ 
                "marks FROM customers WHERE (CustomerID = @CustomerID)"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT CustomerID, CustomerCompany, CustomerName, CustomerAddress, CustomerPhone,"& _ 
                " CustomerTIN, CustomerRemarks FROM dbo.customers"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As inventoryDataSet4.customersDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As inventoryDataSet4.customersDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As inventoryDataSet4.customersDataTable = New inventoryDataSet4.customersDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As inventoryDataSet4.customersDataTable) As Integer
        ...
        Public Overloads Overridable Function Delete(ByVal Original_CustomerID As Integer, ByVal Original_CustomerCompany As String, ByVal Original_CustomerName As String, ByVal Original_CustomerAddress As String, ByVal Original_CustomerPhone As String, ByVal Original_CustomerTIN As String, ByVal Original_CustomerRemarks As String) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal CustomerID As Integer, ByVal CustomerCompany As String, ByVal CustomerName As String, ByVal CustomerAddress As String, ByVal CustomerPhone As String, ByVal CustomerTIN As String, ByVal CustomerRemarks As String) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal CustomerID As Integer, ByVal CustomerCompany As String, ByVal CustomerName As String, ByVal CustomerAddress As String, ByVal CustomerPhone As String, ByVal CustomerTIN As String, ByVal CustomerRemarks As String, ByVal Original_CustomerID As Integer, ByVal Original_CustomerCompany As String, ByVal Original_CustomerName As String, ByVal Original_CustomerAddress As String, ByVal Original_CustomerPhone As String, ByVal Original_CustomerTIN As String, ByVal Original_CustomerRemarks As String) As Integer
            ...
            If (Original_CustomerCompany Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_CustomerCompany")
            Else
                Me.Adapter.UpdateCommand.Parameters(8).Value = CType(Original_CustomerCompany,String)
            End If
            If (Original_CustomerName Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_CustomerName")
            Else
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(13).Value = CType(Original_CustomerPhone,String)
            End If
            If (Original_CustomerTIN Is Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(15).Value = CType(Original_CustomerTIN,String)
            End If
            If (Original_CustomerRemarks Is Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(17).Value = CType(Original_CustomerRemarks,String)
            End If
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal CustomerCompany As String, ByVal CustomerName As String, ByVal CustomerAddress As String, ByVal CustomerPhone As String, ByVal CustomerTIN As String, ByVal CustomerRemarks As String, ByVal Original_CustomerID As Integer, ByVal Original_CustomerCompany As String, ByVal Original_CustomerName As String, ByVal Original_CustomerAddress As String, ByVal Original_CustomerPhone As String, ByVal Original_CustomerTIN As String, ByVal Original_CustomerRemarks As String) As Integer
            Return Me.Update(Original_CustomerID, CustomerCompany, CustomerName, CustomerAddress, CustomerPhone, CustomerTIN, CustomerRemarks, Original_CustomerID, Original_CustomerCompany, Original_CustomerName, Original_CustomerAddress, Original_CustomerPhone, Original_CustomerTIN, Original_CustomerRemarks)
        End Function
    End Class
